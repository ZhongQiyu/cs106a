...
# .json files are JavaScript-based ones that enable
# easy processing on nested data. In this case, we
# need to understand how the key-value works to obtain
# timestamp and hour
...
def make_bar_plot(count_map):
    ...
    # see the similarity of how the variable data
    # is constructed as the way the .json file includes
    # data in a nested manner? this is a data type
    # called dictionary in Python, another good one.
